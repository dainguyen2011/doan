        ...
        @endif
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="preview text-center">
                    <img class="preview-img" src="{{url('/')}}/{{Auth::user()->avatar}}" alt="Preview Image" width="200" height="200"/>
                    <label for="image"><i style="color: red; display: contents" class="fa fa-pencil"></i> </label>
